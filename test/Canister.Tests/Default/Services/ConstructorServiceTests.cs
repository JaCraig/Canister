...
namespace Canister.Tests.Default.Services
{
    public class ConstructorServiceTests : ServiceTestBase
    {
        ...
        //[InlineData(typeof(ClassWithOptionalParameters), typeof(ClassWithOptionalParameters), 123)]
        //[InlineData(typeof(ClassWithStringParameter), typeof(ClassWithStringParameter), 454)]
        //[InlineData(typeof(ClassWithOptionalBoolParameter), typeof(ClassWithOptionalBoolParameter), 10)]
        ...
        //    var ReturnedValue = (ISimpleInterface)TestObject.Create(ServiceProvider);
        ...
        {
            var TestObject = new ConstructorService(typeof(int), typeof(int), new ServiceTable(new ServiceCollection(), null), ServiceLifetime.Transient);
