...
{
    /// <summary>
    /// Generic Scoped type builder
    /// </summary>
    /// <seealso cref="GenericTypeBuilderBase"/>
    /// <seealso cref="IScopedTypeBuilder"/>
    public class GenericScopedTypeBuilder : GenericTypeBuilderBase, IScopedTypeBuilder
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GenericScopedTypeBuilder"/> class.
        /// </summary>
        ...
        {
            return new GenericScopedTypeBuilder(Implementation, ReturnType);
        }
