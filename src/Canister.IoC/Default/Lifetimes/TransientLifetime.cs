...
namespace Canister.Default.Lifetimes
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransientLifetime"/> class.
        /// </summary>
        /// <param name="implementation">The implementation.</param>
        /// <param name="returnType">Type of the return.</param>
        public TransientLifetime(Func<IServiceProvider, object> implementation, Type returnType)
        ...
        {
            return new TransientLifetime(Implementation, ReturnType);
        }
